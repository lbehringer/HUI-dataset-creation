...
class Step3_1_PrepareText:
    ...
    def replace(self, text: str, text_replacement: Dict[str, str]):
        ...
        # use default abbreviations if there are no book-specific abbreviations 
        # NB: This makes checking for remaining abbreviations useless
        if len(text_replacement) == 0:
            text_replacement = default_abbreviations[self.language]
        ...
        short_words = {"en": [' h.', ' at.', ' be.', ' by.', ' do.', ' it.', ' me.', ' of.', ' to.', ' up.', ' us.', ' go.', ' in.', ' is.', ' on.', ' so.', ' II.', ' IT.', ' IV.', ' IX.', ' PH.', ' VI.', ' XI.', ' XV.', ' XX.'],
                       "de": [' Co.', ' go.', ' Da.',' na.',' ab.', ' an.', ' da.', ' du.', ' er.', ' es.', ' ja.', ' so.', ' um.', ' zu.', ' Ja.', ' Ad.', ' je.', ' Es.', ' ob.', ' is.', ' tu.', ' Hm.', ' So.', ' wo.', ' ha.', ' he.', ' Du.', ' du.', ' Nu.', ' in.'],
                       "fr": [' y.', ' ci.', ' en.', ' et.', ' il.', ' la.', ' nu.', ' on.', ' pu.', ' un.', ' va.', ' vu.', ' Co.', ' go.', ' Da.',' na.',' ab.', ' an.', ' da.', ' du.', ' er.', ' es.', ' ja.', ' so.', ' um.', ' zu.', ' Ja.', ' Ad.', ' je.', ' Es.', ' ob.', ' is.', ' tu.', ' Hm.', ' So.', ' wo.', ' ha.', ' he.', ' Du.', ' du.', ' Nu.', ' in.']
        }
        possible_abbreviations = [ab for ab in possible_abbreviations if ab not in short_words[self.language]]
