...
class Step2_SplitAudio:
    ...
    def __init__(self, audio_split_transformer: AudioSplitTransformer, audio_persistence: AudioPersistence, save_path: str, book_name: str, audio_loudness_transformer: AudioLoudnessTransformer, remap_sort: List[int] = None):
